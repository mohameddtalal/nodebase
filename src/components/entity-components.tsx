...
isCreating?:boolean;    
    ...
    | {onNew:()=>void ; newButtonHref?: never} //add new workflow
    ...
    return(
      <div className="flex flex-row items-center justify-between gap-x-4" >
        <div className="flex flex-col">
            <h1 className="text-lg md:xl font-semibold">{title}</h1>
            {description && (
...
>
<CardContent className="flex flex-row items-center justifi-between p-0">
